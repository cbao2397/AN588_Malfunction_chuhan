...
**Conclusion: **I would say that the log one seems better. The un-transformed graph looks largely affected by a few data which don't really belong to the general trend...Besides, I won't say the two variables involved in this challenge have perfect (or at least, relatively nice) correlation, so I am not sure if I can actually trust the result. I think I will just consider the prediction result as a possibility, but not 100% trust it. 

# Comments

1. This homework absolutely killed many of my brain cells (and I don't actually have many before doing this (just kidding) ). I didn't expect the homework to be like this when I saw "simple function" in the instruction. According to my peer's commentary I think I am not the only one feeling this way. Malik (the student commented on my work) definitely suffered from this homework too. 

2. Shoutout to Malik. Really helpful commentary. 

3. This is great practice, I guess! Although I don't want to do it again! 
